...
namespace DuiLib
{
	class CWebBrowserEventHandlerIE: public CWebBrowserEventHandler
	{
	public:
		CWebBrowserEventHandlerIE() {}
		~CWebBrowserEventHandlerIE() {}

		virtual PVOID GetInterface(LPCTSTR _name)
		{
			if ( _tcscmp(_name, DUI_WEB_BROWSER_EVENT_HANDLER_IE) == 0 ) {
				return static_cast<CWebBrowserEventHandlerIE*>(this);
			}
			return NULL;
		}
